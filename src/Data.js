export const projects = [
  ...
  },
  {
    ...
    github: "https://github.com/vidyadhar03/Neat-Code",
    description: "Neat Code, akin to LeetCode, is a platform for coding practice and collaboration, built with React.js and Express.js. It provides an interactive environment for learning and sharing among coding enthusiasts",
    sitelink: "https://google.com",
  },
  {
    title: "Thought Tracker",
    stack: ["Android Studio", "Kotlin"],
    github: "https://github.com/vidyadhar03/ThoughtTracker",
    description: "Thought Tracker is a minimalist Android app designed for introspection and personal reflection. It offers a straightforward and user-friendly platform for users to record and track their thoughts, aiding in self-awareness and mindfulness.",
    sitelink:
